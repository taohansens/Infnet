...
Usando a biblioteca Pygame, escreva um programa que implemente o jogo “Pong” alterado na questão anterior e que adicione
 uma nova modificação. Tal modificação consiste em aumentar o ganho de pontos para cada vez que a bola encostar na
 paleta do jogador1. O aumento da pontuação será também realizada de maneira gradual, porém somente a cada 2 aumentos
 da velocidade da bola, isto é 1 ponto será atribuído ao total de pontos que o jogador ganha a cada vez que a bola bate
 na paleta. (código e printscreen)
# Reaproveitando codigo questão 17
"""
...
def main():
    ...
    while True:
        ...
        if JOGADOR == 1:
            ...
            placar_left, placar_right = verifica_placar(paleta1, paleta2, bola, placar_left, placar_right, bolaDirX, velocidade_vezes)
